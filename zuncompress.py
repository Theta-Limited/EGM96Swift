...
parser = argparse.ArgumentParser(description='Uncompress a file using zlib')

parser.add_argument('infile', help='Input file to be uncompressed')
parser.add_argument('outfile', help='Output file to store uncompressed data')
